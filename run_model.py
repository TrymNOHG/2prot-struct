...
# TODO: plot train and test accuracy for each epoch during training to see if overfit and if we should early stop
...
X_train_train, y_train = smote_oversample(X_train, y_train)

model.fit(X_train, y_train, epochs=20)
y_pred = model.pred(X_test, y_test)
